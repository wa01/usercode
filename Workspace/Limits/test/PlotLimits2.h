...
// Contour found "manually" from histogram
// Standard sequence:
//   PlotLimits2::Loop to fill the histograms
//   PlotLimits2::drawHistograms() to draw histograms and
//     contour lines (automatically saves the Canvas
//     as pdf)
//  PlotLimits2::saveContours() to save the contour lines
//     to a root file
//////////////////////////////////////////////////////////


#ifndef PlotLimits2_h
#define PlotLimits2_h
...
public:
  ...
  //
  PlotLimits2(TFile* file, float level=0.05, float relmax=5.);
  virtual ~PlotLimits2();
  // 
...
#ifdef PlotLimits2_cxx
PlotLimits2::PlotLimits2(TFile* file, float level, float relmax) : 
...
PlotLimits2::~PlotLimits2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PlotLimits2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PlotLimits2::LoadTree(Long64_t entry)
{
...
void PlotLimits2::Init(TTree *tree)
{
...
void PlotLimits2::Show(Long64_t entry)
{
...
Int_t PlotLimits2::Cut(Long64_t entry)
{
