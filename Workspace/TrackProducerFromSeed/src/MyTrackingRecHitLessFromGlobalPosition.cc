#include "Workspace/TrackProducerFromSeed/interface/MyTrackingRecHitLessFromGlobalPosition.h"

#include "Utilities/General/interface/CMSexception.h"
#include "DataFormats/SiStripDetId/interface/StripSubdetector.h"
#include "DataFormats/SiPixelDetId/interface/PixelSubdetector.h"

bool MyTrackingRecHitLessFromGlobalPosition::insideOutLess(  const TrackingRecHit& a, const TrackingRecHit& b) const{
  ...
  throw Genexception("MyTrackingRecHitLessFromGlobalPosition: arguments are not Ok");
}

bool MyTrackingRecHitLessFromGlobalPosition::barrelForwardLess(  const TrackingRecHit& a, const TrackingRecHit& b) const{
  //
