...
template = Template('/data/trauner/Counts/Counts_SMS_T1tttt_${lepton}_selfEff_newMCEff_Eff24Feb/${lepton}_SMS_T1tttt_${ht}_ht_${met}_barepfmet_allJets_withEffgt500_eff24Feb_absoluteErr_selfEff.py')
#
...
#        if not met in effDict[ht]:  effDict[ht][met] = {}
        ...
        for label in nbtags:
            ...
            for signal in nbtags[label]:
                ...
                msugraString = signal.replace("signal_","T1tttt_")
                msugraString += "_-1"
...
# write dictionary
#
fout = open("T1ttttBeffSyst.pkl","wb")
