#ifndef TrackCandidate_MyTrackingRecHitLessFromGlobalPosition_H
#define TrackCandidate_MyTrackingRecHitLessFromGlobalPosition_H
...
class MyTrackingRecHitLessFromGlobalPosition {
public:

  MyTrackingRecHitLessFromGlobalPosition( const TrackingGeometry * geometry_, PropagationDirection dir = alongMomentum) :
