#ifndef TrackCandidate_MyTrackingRecHitLess_H
#define TrackCandidate_MyTrackingRecHitLess_H
...
class MyTrackingRecHitLess {
public:

  MyTrackingRecHitLess( const TrackingGeometry * geometry_, PropagationDirection dir = alongMomentum) :
    g_(geometry_){
